...
def send_email(to_email, subject, body):
    ...
    try:
        ...
        server.login(os.getenv("SMTP_USER", "alert.system26@gmail.com"), os.getenv("SMTP_PASSWORD","ytgu xjmu uxbp ezvv"))
        server.sendmail(os.getenv("SMTP_USER", "alert.system26@gmail.com" ), to_email, messaggio.as_string())
...
while True:
    ...
    try:
        ...
        to_email = data['email']
        subject = f"Alert ticker '{data['ticker']}' "
